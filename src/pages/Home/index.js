...
export default function Home() {
    ...
    const createTeam = () => {
        ...
        return (
            <button className="homeButton" onClick={create}>
                <People color="#FAFAFA" variant="Bold" size={24} className="icon"/>
                {context.size ? "Team" : "Create Team"}
            </button>
        )
    }
    ...
    const createProject = () => {
        ...
        return (
            <button className="homeButton" onClick={create}>
                <LampCharge color="#FAFAFA" size={24} className="icon"/>
                {context.size ? "Project" : "Create Project"}
            </button>
        )
    }
    ...
    const createArticle = () => {
        ...
        return (
            <button className="homeButton" onClick={create}>
                <Notepad2 color="#FAFAFA" size={24} className="icon"/>
                {context.size ? "Article" : "Create Article"}
            </button>
        )
    }
